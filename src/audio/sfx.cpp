...
static const Note SND_MODEM[] = {
    ...
    // Phase 2: Answer tone (shorter — was 1200, now 400)
    {2100, 400, 0},

    // Phase 3: V.34 handshake — frequency hopping (shorter notes)
    {800, 20, 5}, {1200, 20, 5}, {600, 20, 5},
    {1800, 20, 5}, {1400, 20, 5}, {2200, 20, 5},
    {500, 25, 5}, {1600, 25, 5}, {800, 25, 5},
    {2400, 25, 5}, {1100, 20, 5}, {1900, 20, 5},
    {700, 20, 6}, {2600, 20, 6}, {1000, 20, 5},
    {1500, 25, 5}, {2800, 25, 5}, {400, 20, 5},
    {2000, 20, 5}, {1200, 20, 5}, {3000, 25, 5},
    {900, 20, 5}, {1700, 20, 6}, {2300, 20, 5},
    {600, 25, 5}, {2500, 25, 5}, {1400, 20, 5},
    {1800, 20, 5}, {2100, 25, 5}, {800, 20, 5},
    {2700, 20, 5}, {1100, 20, 6}, {1600, 25, 5},
    {3000, 20, 5}, {500, 20, 5}, {2200, 20, 5},
    {1300, 20, 5}, {1900, 25, 5}, {2400, 20, 6},
    {700, 20, 5}, {2800, 25, 5},

    // Phase 4: Protocol negotiation "hiss" (shorter bursts)
    {1200, 12, 2}, {1800, 12, 2}, {900, 12, 2}, {2400, 12, 2},
    {600, 12, 2},  {2100, 12, 2}, {1500, 12, 2}, {800, 12, 2},
    {2600, 12, 2}, {1100, 12, 2}, {1900, 12, 2}, {700, 12, 2},
    {2300, 12, 2}, {1400, 12, 2}, {1000, 12, 2}, {2700, 12, 2},
    {400, 12, 2},  {1700, 12, 2}, {2200, 12, 2}, {1300, 12, 2},
    {800, 12, 2},  {2500, 12, 2}, {600, 12, 2},  {1800, 12, 2},
    {2000, 12, 2}, {1100, 12, 2}, {2900, 12, 2}, {900, 12, 2},
    {1500, 12, 2}, {2400, 12, 2}, {700, 12, 2},  {1600, 12, 2},
    {2100, 12, 2}, {1200, 12, 2}, {2800, 12, 2}, {500, 12, 2},
    {1700, 12, 2}, {2300, 12, 2}, {1000, 12, 2}, {1900, 12, 2},

    // Phase 5: Carrier tone (shorter)
    {1800, 150, 0},
    {0, 0, 0}
};
