...
// DTMF dialing → 2100Hz answer tone → V.34 handshake → carrier
static const Note SND_MODEM[] = {
    // Phase 1: DTMF dialing (3 pulses)
    {941, 50, 10}, {1336, 50, 10},
    {941, 50, 10}, {1336, 50, 10},
    {0, 400, 0},

    // Phase 2: Answer tone (shorter)
    {2100, 600, 0},

    // Phase 3: Handshake squeal (stepped)
    {800, 40, 6}, {1600, 40, 6}, {600, 30, 6},
    {2400, 30, 6}, {1200, 30, 6}, {2000, 30, 6},
    {700, 25, 6}, {2600, 25, 6}, {1400, 25, 6},
    {3000, 40, 6}, {500, 30, 6}, {1800, 30, 50},
