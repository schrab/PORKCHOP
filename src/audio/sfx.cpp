...
// DTMF dialing → 2100Hz answer tone → V.34 freq-hopping handshake → noise → carrier
static const Note SND_MODEM[] = {
    // Phase 1: Off-hook + DTMF "dialing" (6 pulses, 941/1336 alternation)
    {941, 50, 10}, {1336, 50, 10},
    {941, 50, 10}, {1336, 50, 10},
    {941, 50, 10}, {1336, 50, 10},
    {941, 50, 10}, {1336, 50, 10},
    {941, 50, 10}, {1336, 50, 10},
    {941, 50, 10}, {1336, 50, 10},
    {0, 500, 0},         // silence (negotiation pause)

    // Phase 2: Answer tone (2100 Hz, ~1.2s)
    {2100, 1200, 0},

    // Phase 3: V.34 handshake — frequency hopping (deterministic stand-in for random)
    {800, 25, 6}, {1200, 25, 6}, {600, 25, 6},
    {1800, 25, 6}, {1400, 25, 6}, {2200, 25, 6},
    {500, 30, 6}, {1600, 30, 6}, {800, 30, 6},
    {2400, 30, 6}, {1100, 25, 6}, {1900, 25, 6},
    {700, 25, 8}, {2600, 25, 8}, {1000, 25, 6},
    {1500, 30, 6}, {2800, 30, 6}, {400, 25, 6},
    {2000, 25, 6}, {1200, 25, 6}, {3000, 30, 6},
    {900, 25, 6}, {1700, 25, 8}, {2300, 25, 6},
    {600, 30, 6}, {2500, 30, 6}, {1400, 25, 6},
    {1800, 25, 6}, {2100, 30, 6}, {800, 25, 6},
    {2700, 25, 6}, {1100, 25, 8}, {1600, 30, 6},
    {3000, 25, 6}, {500, 25, 6}, {2200, 25, 6},
    {1300, 25, 6}, {1900, 30, 6}, {2400, 25, 8},
    {700, 25, 6}, {2800, 30, 6},

    // Phase 4: Protocol negotiation "hiss" (rapid noise-burst simulation, 80 steps)
    {1200, 15, 2}, {1800, 15, 2}, {900, 15, 2}, {2400, 15, 2},
    {600, 15, 2},  {2100, 15, 2}, {1500, 15, 2}, {800, 15, 2},
    {2600, 15, 2}, {1100, 15, 2}, {1900, 15, 2}, {700, 15, 2},
    {2300, 15, 2}, {1400, 15, 2}, {1000, 15, 2}, {2700, 15, 2},
    {400, 15, 2},  {1700, 15, 2}, {2200, 15, 2}, {1300, 15, 2},
    {800, 15, 2},  {2500, 15, 2}, {600, 15, 2},  {1800, 15, 2},
    {2000, 15, 2}, {1100, 15, 2}, {2900, 15, 2}, {900, 15, 2},
    {1500, 15, 2}, {2400, 15, 2}, {700, 15, 2},  {1600, 15, 2},
    {2100, 15, 2}, {1200, 15, 2}, {2800, 15, 2}, {500, 15, 2},
    {1700, 15, 2}, {2300, 15, 2}, {1000, 15, 2}, {1900, 15, 2},

    // Phase 5: Carrier tone (1800 Hz steady)
    {1800, 300, 0},
    {0, 0, 0}
};
...
static void startSequence(const Note* seq) {
    ...
    if (seq[0].freq > 0 && seq[0].duration > 0) {
        hal_audio_play(seq[0].freq, seq[0].duration);
    }
}
