...
private:
    ...
    static void drawStars(DisplayCanvas& canvas);
    static void fillPigBoundingBox(DisplayCanvas& canvas);
    ...
    static void drawFrame(DisplayCanvas& canvas, const char** frame, uint8_t lines, bool blink = false, bool faceRight = true, bool sniff = false);
    static void drawGrass(DisplayCanvas& canvas);
