...
private:
    ...
    static void drawStatsTab(DisplayCanvas& canvas);
    static void drawBuffsTab(DisplayCanvas& canvas);
    static void drawTabBar(DisplayCanvas& canvas);
    static void drawStats(DisplayCanvas& canvas);  // Stat grid helper
    ...
    static void drawWigleTab(DisplayCanvas& canvas);
};