...
void BountyStatusMenu::draw(DisplayCanvas& canvas) {
...
void BountyStatusMenu::drawList(DisplayCanvas& canvas) {
...
void BountyStatusMenu::drawEmpty(DisplayCanvas& canvas) {
